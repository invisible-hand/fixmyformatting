...
import { fontsForLocale } from "@/lib/og-fonts";
    ...
    return new ImageResponse(
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: 72, background: "#f6f7f5", color: "#17201a", fontFamily: "Site" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 1040 }}>
          ...
          <div style={{ marginTop: 15, fontSize: 64, lineHeight: 1.04, fontWeight: 700, letterSpacing: -3 }}>{guide.h1}</div>
      ...
      { width: 1200, height: 630, fonts: fontsForLocale("en"), headers: { "cache-control": "public, max-age=86400, s-maxage=604800" } },
    );
  });
}
