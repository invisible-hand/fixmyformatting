...
export const brand: BrandCopy = {
  ...
  actionDescription: {
    "to-word": "{brand} 답변을 제목 스타일, 편집 가능한 표, 중첩 목록, 링크, 코드가 담긴 진짜 .docx로 바꿉니다. 브라우저에서 만들어집니다.",
    ...
    "table-to-excel": "한 열에 붙여넣어진 {brand} 표를 셀마다 값이 하나씩 들어가고 숫자는 숫자로 남는 진짜 .xlsx로 내려받습니다.",
    "remove-formatting": "{brand} 답변에서 별표, 해시, 링크 문법을 제거하되 단어는 그대로 둡니다. URL, 목록, 코드는 유지할 수 있고 변경 내용도 볼 수 있습니다.",
  },
  actionGuidance: {
    ...
    "table-to-excel": "{brand} 표가 파이프가 그대로 보이는 채로 열 하나에 붙여넣어질 때 사용하세요. 미리보기로 셀 모습을 먼저 보여주고, 다운로드는 진짜 .xlsx입니다.",
    "remove-formatting": "{brand}의 별표와 제목 기호가 그대로 노출되는 이메일, 양식, 메신저, 편집기에서 깔끔한 텍스트를 사용하세요. 편집기 위 스위치로 URL, 목록 기호, 코드를 유지할 수 있습니다.",
  },
  reasons: {
