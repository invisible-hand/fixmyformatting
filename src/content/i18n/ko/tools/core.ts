...
export const tools: Partial<Record<string, ToolCopy>> = {
  ...
  "text-splitter": {
    ...
    intro: "긴 문서를 문단 경계 근처에서 실용적인 크기의 조각으로 나눕니다. 단어가 중간에 잘리지 않아 내용을 프롬프트에 그대로 담기 좋습니다.",
    faqs: [
      { question: "텍스트 분할 도구는 무료인가요?", answer: "네. 무료이며 계정이나 사용 제한이 없습니다." },
      { question: "텍스트가 어떻게 나뉘나요?", answer: "단어가 중간에 끊기지 않도록 문단 경계 근처에서 나누며, 각 조각은 바로 복사해 프롬프트에 붙여넣을 수 있습니다." },
      { question: "텍스트가 업로드되나요?", answer: "아니요. 브라우저에서 처리됩니다. 공유 링크를 직접 만들 때만 저장됩니다." },
    ],
  },
  "text-diff": {
