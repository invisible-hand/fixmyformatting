...
export const guide: GuideTranslation = {
  ...
  faqs: [
    ...
    { question: "كيف أعثر على المحارف غير المرئية في نصي؟", answer: "الصقه في فاحص يسرد نقاط الترميز، مثل فاحص المحارف غير المرئية لدينا. يحدد كل نوع من المحارف غير المرئية الموجودة ويعدّها ويزيلها عند الطلب، ويعمل بالكامل داخل متصفحك." },
