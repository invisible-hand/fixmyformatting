...
export const pages: PageCopy = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        heading: "Analytics",
        body: ["We collect aggregate page and interaction counts to understand which tools are useful. We use Vercel Analytics, which is cookieless, and Google Analytics, which sets cookies to measure visits and sessions. We do not sell personal information."],
      },
    ],
  },
  notFound: {
